...
type RoleSelection = "PARTICIPANT" | "ORGANIZER" | null;
...
const RegisterForm = () => {
    ...
    const form = useForm({
        ...
        onSubmit: async ({ value }) => {
            setServerError(null);
            try {
                // Attach the explicitly chosen role to bypass form-binding complexity
                const finalPayload = { ...value, role: selectedRole as "PARTICIPANT" | "ORGANIZER" };
                const result = await mutateAsync(finalPayload) as any;
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <CardContent className="text-center text-muted-foreground flex-grow">
                            Discover events, manage your tickets, track your invitations, and connect with organizers!
                        </CardContent>
                        <CardFooter>
                            <Button className="w-full" variant="outline">Continue as Participant</Button>
                        </CardFooter>
                    </Card>
                    ...
                    >
                        <CardHeader className="text-center">
                            ...
                            <CardTitle>Join as Organizer</CardTitle>
                        </CardHeader>
                        <CardContent className="text-center text-muted-foreground flex-grow">
                            Host public or private events, sell tickets, manage attendees, and expand your community!
                        </CardContent>
                        <CardFooter>
                            <Button className="w-full" variant="outline">Continue as Organizer</Button>
                        </CardFooter>
                    </Card>
                </div>
        ...
        <Card className="w-full max-w-md mx-auto shadow-md">
            ...
            <CardContent>
                            ...
                            {(field) => (
                                <div className="space-y-1.5">
                                    ...
                                    <Select 
                                        ...
                                        onValueChange={(val) => field.handleChange(val as "MALE"|"FEMALE"|"OTHER")}
                                    >
                                        <SelectTrigger>
                ...
                <Button variant="outline" className="w-full" onClick={() => {
                    ...
                    const defaultDashboard = selectedRole === "ORGANIZER" ? "/organizer/dashboard" : "/dashboard";
                    window.location.href = `${baseUrl}/auth/login/google?redirect=${defaultDashboard}&role=${selectedRole}`;
                }}>
