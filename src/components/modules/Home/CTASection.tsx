...
export function CTASection() {
  return (
    <section className="px-8 max-w-[1440px] mx-auto mb-40">
      <div className="bg-primary text-white p-16 lg:p-24 rounded-3xl relative overflow-hidden text-center">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <h2 className="font-newsreader text-5xl lg:text-6xl font-medium mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/dashboard" className="bg-white text-primary px-12 py-4 rounded-full text-[0.75rem] font-bold tracking-[0.1rem] uppercase hover:opacity-90 transition-opacity">
              Create Events
            </Link>
            <Link href="/events" className="border border-white/30 text-white px-12 py-4 rounded-full text-[0.75rem] font-bold tracking-[0.1rem] uppercase hover:bg-white/10 transition-all">
              Join Events
            </Link>
          </div>
        </div>
